    ...
    companion object {
        ...
        fun description(type: Int): String {
            return when (type) {
                ...
                TiffConstants.DIRECTORY_TYPE_IFD0 -> "IFD0"
                TiffConstants.DIRECTORY_TYPE_IFD1 -> "IFD1"
                TiffConstants.DIRECTORY_TYPE_IFD2 -> "IFD2"
                ...
                TiffConstants.TIFF_DIRECTORY_INTEROP_IFD -> "InteropIFD"
