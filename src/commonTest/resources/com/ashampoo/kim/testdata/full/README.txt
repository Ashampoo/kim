...
photo_60.heic = iPhone SE OOC-HEIC
photo_73.heic = same as photo_60.heic, but added XMP using exiftool
photo_74.heic = resaved photo_60.heic using GIMP (metadata lost)
pnoto_75.heic = photo_1.jpg converted to HEIC using GIMP (metadata lost)
